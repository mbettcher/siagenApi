...
public class SiagenApiApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Dia d1 = new Dia(null, LocalDate.now().plusDays(2));
		Dia d2 = new Dia(null, LocalDate.now().plusDays(3));
		...
		ConfigAgendamento cfa1 = new ConfigAgendamento(null, LocalDate.now().plusDays(2), LocalDate.now().plusDays(2), LocalTime.of(8, 0), LocalTime.of(16, 0), false, false, true);
