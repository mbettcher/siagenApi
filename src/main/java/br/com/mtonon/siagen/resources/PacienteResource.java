...
public class PacienteResource {
	...
	public ResponseEntity<Paciente> findByCpf(@RequestParam(value = "value") String cpf) {
	...
	public ResponseEntity<Void> update(@PathVariable Integer id, @Valid @RequestBody PacienteDTO objDTO,
